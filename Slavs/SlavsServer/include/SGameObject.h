...
class SGameObject : public IGameObject
{
public:
	enum component_type
	{
	...
	SGameObject(SGameContext *pContext, long ID, ObjectType otype, int iMask = 0x00, const TiXmlElement* configElement = NULL, Vector2D* extraData = NULL, IController* owner = NULL);
	virtual ~SGameObject();
