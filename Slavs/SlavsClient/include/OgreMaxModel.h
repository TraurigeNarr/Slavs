#ifndef OgreMaxModel_h
#define OgreMaxModel_h
...
namespace OgreMax
{
	...
	public:
		...
		Ogre::SceneNode* CreateInstance
			...
			QueryMask queryMask = QM_Resources,
		...
		Types::EntityParameters* GetEntityParameters();
private:
		Ogre::SceneNode* CreateInstance
			(
			Ogre::SceneManager* sceneManager,
...
/*
	...
	protected:
		Types::NodeParameters m_RootNode;
	...
	public:
		...
		virtual void ReferencedNodeAnimationState(const OgreMaxModel* model, Ogre::SceneNode* node, Ogre::AnimationState* animationState) {}
